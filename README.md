...
```bash
git clone https://github.com/gokhanmeteerturk/StoryRehearsalSimulator.git
cd StoryRehearsalSimulator
ls
```
...
```bash
git pull && sudo docker stop StoryRehearsalSimulator-app-1 && sudo docker compose up -d --build
```
...
This project is part of an ongoing research. We welcome contributions regarding the security concerns only.
